...
class IGLSurfaceView(context: Context) : GLSurfaceView(context), View.OnTouchListener {
...
//                0.5f, -0.5f
    ...
    private fun isRangeOfView(
        ...
        return ev_x > dx - 80 && ev_x < dx + 80 && ev_y > dy - 80 && ev_y < dy + 80
    }
}