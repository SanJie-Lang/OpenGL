...
import com.cbsd.opengl.utils.BufferUtil
import com.cbsd.opengl.utils.ProjectionMatrixHelper
import com.cbsd.opengl.utils.TextureHelper
 ...
 * @author Benhero
 */
class ImageRender(context: Context) : BaseRenderer(context) {
    companion object {
    ...
    fun refresh(data: FloatArray) {
        mVertexData = BufferUtil.createFloatBuffer(data)
    }
    ...
    override fun onDrawFrame(glUnused: GL10) {
        ...
        // 纹理数据
        mTextureBean = TextureHelper.loadTexture(context, R.mipmap.icon_temp_avatar)
